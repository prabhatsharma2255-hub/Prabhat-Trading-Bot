...
HTML = (
    ...
    '<table><thead><tr><th>Dir</th><th>Entry</th><th>Size</th><th>Lev</th><th>SL</th><th>TP</th><th>PnL</th><th></th></tr></thead><tbody>__OPENROWS__</tbody></table>'
    '<div class=tab-bar>'
    ...
    '<table><thead><tr><th>Dir</th><th>Entry</th><th>Exit</th><th>Size</th><th>Lev</th><th>PnL</th><th>Result</th><th>Time</th></tr></thead><tbody>__TODAYROWS__</tbody></table></div>'
    ...
    '<table><thead><tr><th>Dir</th><th>Entry</th><th>Exit</th><th>Size</th><th>Lev</th><th>PnL</th><th>Result</th><th>Time</th></tr></thead><tbody>__YESTROWS__</tbody></table></div>'
    '<div id=tab-all class=tab-content>'
    '<div class=section-title>All Closed Trades <span style=color:#888;font-weight:normal>(__ALLLEN__)</span></div>'
    '<table><thead><tr><th>Dir</th><th>Entry</th><th>Exit</th><th>Size</th><th>Lev</th><th>PnL</th><th>Result</th><th>Time</th></tr></thead><tbody>__ALLROWS__</tbody></table></div>'
